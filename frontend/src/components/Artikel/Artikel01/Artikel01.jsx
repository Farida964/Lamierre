  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.bannerWrapper}>
        ...
        <div className={styles.textkanan}>
          ...
          <h5 className={styles.isi}>
            AQDISHA, dari kata Baitul Maqdis, yang menjadi saksi bisu kisah pembebasan al-Aqsa dari tangan Tentara
            ...
            dalam hidup, namanya Ismatuddin Khatun.
          </h5>
        </div>
      </div>
      ...
      <span className={styles.detail}>
        ...
        cerdas, visioner namun tetap menawan saat digunakan. Cocok digunakan untuk perempuan yang ingin tampil
        dengan kesan cerdas, impian besar penuh keanggunan.
      </span>
